...
//	router.HandlerFunc(http.MethodGet, "/listing/", s.listing)
//	router.HandlerFunc(http.MethodGet, "/delete/", s.delete)
//	router.HandlerFunc(http.MethodGet, "/update/", s.update)
//	router.HandlerFunc(http.MethodGet, "/add/", s.add)
//	return router
//}
//
